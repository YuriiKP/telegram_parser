...
async def process_task(task: ParsingTask):
    ...
    await bot.send_message(
        ...
        text=f"❌ Задача парсинга #{task.id} завершена с ошибкой после {attempt} попыток.\n"
            "<b>Возможная причина:</b> Несоответствие типа задачи и выбранного источника.\n\n"
            "<b>Пожалуйста, проверьте настройки:</b>\n"
            "• <b>Парсинг участников:</b> Работает только в группах где открыт список участников.\n"
            "• <b>Парсинг писавших в чат:</b> в каналах не работает.\n"
            "• <b>Парсинг комментаторов:</b> Нужно указывать ссылку на основной канал, где открыты комментарии.\n\n"
    )
